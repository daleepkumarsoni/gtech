                                                ...
                                                <tbody>
                                                    @foreach ($tasks as $tasks)
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                <a href="{{route('user.task.edit',$tasks->id)}}" class="btn btn-info btn-sm">Edit</a>
                                                            </td>
                                                            <td>
                                                                <a href="{{route('employe.comment.task.list',$tasks->id)}}" class="btn btn-info btn-sm">Comment</a>
                                                            </td>
